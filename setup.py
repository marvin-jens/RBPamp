...
if use_cython:
    ext_modules += [
        Extension("cska.cy_kmers", [ "cska/cython/kmers.pyx" ], extra_compile_args=['-fopenmp', '-O3', '-ffast-math'], extra_link_args=['-fopenmp'], ),
        Extension("cska.cy_model", [ "cska/cython/model.pyx" ], extra_compile_args=['-fopenmp', '-O3', '-ffast-math'], extra_link_args=['-fopenmp'], ),
        Extension("cska.cy_fastrand", [ "cska/cython/fastrand.pyx" ], extra_compile_args=['-fopenmp', '-O3'], extra_link_args=['-fopenmp'], ),
